...
echo "* Set up backups (http://blog.domenech.org/2013/01/backing-up-ubuntu-using-deja-dup-backup-and-aws-s3.html) (ignore Dropbox, .rubies, .gem, .berkshelf, .cache, .dropbox, .dropbox-dist, .npm, .nvm, .vim/bundle, .heroku, possibly others!)"
